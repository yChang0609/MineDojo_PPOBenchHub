...
from src.core.reward.combat_dense import CombatDenseRewardWrapper
import numpy as np

class CombatSpider(CombatDenseRewardWrapper):
    def __init__(
        self,
        image_size,
        ...
        env = minedojo.make(
            "Combat",
            target_names="spider",
            target_quantities=int(target_quantities),
            reward_weights=float(success_reward),
            # start_position=pos,
            initial_inventory=[
